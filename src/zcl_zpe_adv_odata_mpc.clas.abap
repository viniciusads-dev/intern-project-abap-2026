...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'EstoqueToMaterialSet'                         "#EC NOTEXT
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Asso_PedidoToItems' "#EC NOTEXT
                            iv_left_type        = 'ZTPE_PED_CAB' "#EC NOTEXT
                            iv_right_type       = 'ZTPE_PED_ITEM' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Asso_PedidoToItems
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Numeropedido'   iv_dependent_property = 'Numeropedido' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Asso_PedidoToItemsSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ZTPE_PED_CABSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ZTPE_PED_ITEMSet'             "#EC NOTEXT
                                              iv_association_name      = 'Asso_PedidoToItems' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ZTPE_MATERIAL' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'EstoqueToMaterial' ). "#EC NOTEXT
* Navigation Properties for entity - ZTPE_PED_CAB
lo_entity_type = model->get_entity_type( iv_entity_name = 'ZTPE_PED_CAB' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ZTPE_PED_ITEMSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ZTPE_PED_ITEMSET' "#EC NOTEXT
                                                              iv_association_name = 'Asso_PedidoToItems' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260714142758'.                  "#EC NOTEXT
